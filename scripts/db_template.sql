...
ubuntu@greg-the-trainer:~$ sudo -u postgres pg_dumpall
--
-- PostgreSQL database cluster dump
--
...
CREATE ROLE ubuntu;
ALTER ROLE ubuntu WITH NOSUPERUSER INHERIT NOCREATEROLE CREATEDB LOGIN NOREPLICATION PASSWORD 'md5f7cad21b78daa78aa23429271f416003';
...
CREATE DATABASE carnivorae WITH TEMPLATE = template0 OWNER = ubuntu;
